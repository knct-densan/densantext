...
２. ３つのint型変数を作成します。それぞれに自分の生まれた年、月、日を代入し、それを printfで文章として表示してください。
```
表示例： 私は1991年12月22日生まれです。
```

３. 次の２つの変数の中身を入れ替えてください。(ヒント：変数が別にもう一つ必要になります。)
```
int a = 560;
int b = -2134;
```

４. 14の７乗をプログラムによって計算し、出力(画面に表示)してください。
